...
<?php $__env->startSection('content'); ?>
    ...
    <section class="gallery-section-page">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($bottomFeatureTitle || $bottomFeatureItems->count() || $bottomFeatureImageUrl): ?>
            <section class="gallery-bottom-feature" aria-label="Gallery bottom feature">
                <div class="gallery-bottom-feature-inner">
                    ...
                    <div class="gallery-bottom-feature-media">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($bottomFeatureImageUrl): ?>
                            <img
                                src="<?php echo e($bottomFeatureImageUrl); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/balasona/public_html/resources/views/gallery/section.blade.php ENDPATH**/ ?>