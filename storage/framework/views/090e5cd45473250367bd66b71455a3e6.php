...
<?php $__env->startSection('content'); ?>
    ...
    <?php if (! $__env->hasRenderedOnce('90e2d0be-6db4-4df4-bf25-f1f2fc05e3c8')): $__env->markAsRenderedOnce('90e2d0be-6db4-4df4-bf25-f1f2fc05e3c8'); ?>
        <style>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($secondTitle || $secondText || $secondVideoUrl || $secondItems->count()): ?>
        ...
        <?php if (! $__env->hasRenderedOnce('17642cf3-8254-436d-a4e0-39a54b7cb180')): $__env->markAsRenderedOnce('17642cf3-8254-436d-a4e0-39a54b7cb180'); ?>
            <style>
                .pv-block2{
                    background:#e8d5ac;
                    position:relative;
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($thirdTitle || $thirdTopLeft || $thirdTopRight || $thirdLeftVideoUrl || $thirdRightVideoUrl || $thirdBottomLeft || $thirdBottomRight): ?>
        ...
        <?php if (! $__env->hasRenderedOnce('dc4018bc-1a7b-4cef-bb6e-7a4273dabaed')): $__env->markAsRenderedOnce('dc4018bc-1a7b-4cef-bb6e-7a4273dabaed'); ?>
            <style>
                .pv-block3{
                    background:#f7f5ef;
                    padding:84px 0 96px;
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($afterTitle || $afterTopText || $afterVideoUrl || $afterBottomText): ?>
        ...
        <?php if (! $__env->hasRenderedOnce('97ca1e05-459f-4b87-9967-c8311d638fdc')): $__env->markAsRenderedOnce('97ca1e05-459f-4b87-9967-c8311d638fdc'); ?>
            <style>
                .pv-after-slider{
                    background:#e8d5ac;
                    padding:74px 0 84px;
    ...
    <?php if (! $__env->hasRenderedOnce('6f0d96df-4871-4518-b623-8d12eeb42f11')): $__env->markAsRenderedOnce('6f0d96df-4871-4518-b623-8d12eeb42f11'); ?>
        <style>
            .pv-slider{
                background:#f7f5ef;
                padding:74px 0 90px;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/balasona/public_html/resources/views/pictures-and-videos/index.blade.php ENDPATH**/ ?>