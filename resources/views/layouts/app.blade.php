...
<head>
    ...
    <link href="https://fonts.bunny.net/css?family=zen-old-mincho:400,500,600,700,900|noto-serif:400,500,600,700,800,900|noto-serif-armenian:400,500,600,700,800,900" rel="stylesheet" />
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/articles.css') }}?v={{ filemtime(public_path('assets/css/articles.css')) }}" />
    @stack('styles')
</head>
<body>
